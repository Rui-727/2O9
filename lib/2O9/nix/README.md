...
A C implementation of the Nix expression language, written from
scratch. Not a vendored copy of the C++ nix source. It implements just
enough of the language to evaluate `2O9.nix` config files: the function
form with self-reference, imports, attrsets, lists, lambdas, the usual
builtins.
