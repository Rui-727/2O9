...
/* Add a package to the store with a known name+version.
 * Skips .PKGINFO parsing. Use this when the caller already knows
 * the package name and version (e.g. from the sync DB). */
