...
DECL_SRC  = src/declarative/gen.c src/declarative/reconcile.c src/declarative/reconcile_execute.c src/declarative/activation.c src/declarative/gen_index.c src/declarative/users.c src/declarative/fstab.c src/declarative/bootloader.c src/declarative/services.c src/declarative/pam_nss.c src/declarative/profile_hooks.c
